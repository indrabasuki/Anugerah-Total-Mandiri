<aside class="main-sidebar sidebar-light-primary  fixed">
    <a href="#" class="brand-link logo-switch bg-blue text-center">
        <img src="{{ asset('images/yubi-pro-collapse.svg') }}" alt="Logo" class="brand-image-xl logo-xs">

        <img src="{{ asset('images/logo-yubi.png') }}" alt="Logo" class="brand-image-xs logo-xl mx-5"
             style="left: 12px">
    </a>
